...
pub fn print_quote(quote: Option<&Quote>, add_border: bool, padding: usize) {
    match quote {
        Some(q) => {
            // get width of terminal fuckkk
            ...
            let mut wrapped_lines = wrap_text(&q.quote, wrap_width);
            ...
            // max lin width to determine box size
